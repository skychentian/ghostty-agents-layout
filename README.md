...
```text
请帮我在 macOS 上安装 Ghostty Agents Layout：
...
| 命令 | 功能 |
| --- | --- |
| `ghostty-agents doctor` | 检查 Hammerspoon、Ghostty 窗口和下一步 |
| `ghostty-agents grid` | 把当前桌面的 Ghostty 窗口排成网格 |
| `ghostty-agents sidebar` | 显示 / 隐藏左侧 agents 侧边栏 |
| `ghostty-agents show` | 显示侧边栏 |
| `ghostty-agents hide` | 隐藏侧边栏 |
| `ghostty-agents list` | 在终端打印当前 Ghostty 窗口列表 |
